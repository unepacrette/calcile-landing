...
export const translations = {
  fr: {
    ...
    auth: {
      ...
      signupSubtitle:
        "Accède à Calcile en avant-première pendant la bêta fermée.",
      signupSubmit: "Créer mon compte",
      signupSubmitLoading: "Création…",
      signupEmailInUse: "Un compte existe déjà avec cet email.",
  ...
  en: {
    ...
    auth: {
      ...
      signupSubtitle: "Get early access to Calcile during the closed beta.",
      signupSubmit: "Create my account",
      signupSubmitLoading: "Creating…",
      signupEmailInUse: "An account already exists with this email.",
