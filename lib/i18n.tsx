...
export const translations = {
  fr: {
    ...
    solve: {
      heading: "Calculateur",
      subtitle:
        "Version bêta — résous équations, dérivées, intégrales, matrices et bien plus, étape par étape.",
      examplesHeading: "Essayez un exemple",
      examples: {
        equation: "Équation",
        derivative: "Dérivée",
        integral: "Intégrale",
        limit: "Limite",
        inequality: "Inégalité (encadrement)",
        sets: "Ensembles (abstrait)",
        matrix: "Matrice (transposée)",
        series: "Série de Taylor",
      },
      ...
      tabSets: "Ensembles",
      tabVectors: "Vecteurs",
      setsOperatorUnion: "Union",
      setsOperatorIntersection: "Intersection",
      setsOperatorDifference: "Différence",
      setsOperatorSymmetricDifference: "Différence symétrique",
      setsOperatorIn: "Appartenance",
      setsOperatorSubset: "Inclusion",
      setsOperatorPowerSet: "Ensemble des parties",
      setsOperatorCartesianProduct: "Produit cartésien",
      setsOperatorExpression: "Expression ensembliste",
      vectorOperatorDot: "Produit scalaire",
      vectorOperatorCross: "Produit vectoriel",
      vectorOperatorNorm: "Norme",
      tabPlot: "Graphique 2D",
      tabExerciseCheck: "Correction par lot",
      ...
      exerciseCheckIncorrect: "Incorrect",
      exerciseCheckRealSolutionLabel: "Vraie solution",
      exerciseCheckLockedTitle: "Fonctionnalité réservée au tier Prof",
      exerciseCheckLockedMessage:
        "Vérifie en un lot les réponses de toute une classe à un exercice donné.",
      exerciseCheckLockedCta: "Voir les formules",
      ...
      plotLowerBoundLabel: "Borne inférieure",
      plotUpperBoundLabel: "Borne supérieure",
      plotChartAriaLabel: "Graphique de la fonction",
    ...
    formulaSheet: {
      heading: "Formulaire",
      toggleShow: "Afficher le formulaire",
      toggleHide: "Masquer le formulaire",
      categories: {
        trigonometry: "Trigonométrie",
        taylorSeries: "Développements limités (en 0)",
        derivatives: "Dérivées usuelles",
        antiderivatives: "Primitives usuelles",
        algebraic: "Identités algébriques",
      },
      formulas: {
        trigPythagorean: "Identité fondamentale",
        trigTangent: "Tangente",
        trigDoubleSin: "Angle double — sinus",
        trigDoubleCos: "Angle double — cosinus",
        trigSumSin: "Somme — sinus",
        trigSumCos: "Somme — cosinus",
        trigOnePlusTan2: "1 + tan²(x)",
        taylorExp: "Exponentielle",
        taylorSin: "Sinus",
        taylorCos: "Cosinus",
        taylorLn: "Logarithme de (1+x)",
        taylorGeometric: "1 / (1 − x)",
        taylorBinomial: "(1 + x)^α",
        derivPower: "Puissance",
        derivSin: "Sinus",
        derivCos: "Cosinus",
        derivTan: "Tangente",
        derivExp: "Exponentielle",
        derivLn: "Logarithme népérien",
        derivSqrt: "Racine carrée",
        derivProduct: "Produit (u·v)",
        derivQuotient: "Quotient (u/v)",
        intPower: "Puissance",
        intInverse: "1 / x",
        intExp: "Exponentielle",
        intCos: "Cosinus",
        intSin: "Sinus",
        intArctan: "1 / (1 + x²)",
        intArcsin: "1 / √(1 − x²)",
        algSquareSum: "Carré d'une somme",
        algSquareDiff: "Carré d'une différence",
        algDiffSquares: "Différence de carrés",
        algCubeSum: "Cube d'une somme",
        algDiffCubes: "Différence de cubes",
        algSumCubes: "Somme de cubes",
      },
    },
    footer: {
  ...
  en: {
    ...
    solve: {
      heading: "Calculator",
      subtitle:
        "Beta — solve equations, derivatives, integrals, matrices and more, step by step.",
      ...
      setsOperatorUnion: "Union",
      setsOperatorIntersection: "Intersection",
      setsOperatorDifference: "Difference",
      setsOperatorSymmetricDifference: "Symmetric difference",
      setsOperatorIn: "Membership",
      setsOperatorSubset: "Subset",
      setsOperatorPowerSet: "Power set",
      setsOperatorCartesianProduct: "Cartesian product",
      setsOperatorExpression: "Set expression",
      vectorOperatorDot: "Dot product",
      vectorOperatorCross: "Cross product",
      vectorOperatorNorm: "Norm",
      tabPlot: "2D Plot",
      tabExerciseCheck: "Batch grading",
      ...
      exerciseCheckCorrect: "Correct",
      exerciseCheckIncorrect: "Incorrect",
      exerciseCheckRealSolutionLabel: "Real solution",
      exerciseCheckLockedTitle: "Prof plan feature",
      exerciseCheckLockedMessage:
        "Check a whole class's answers to one exercise in a single batch.",
      exerciseCheckLockedCta: "See plans",
      ...
      plotLowerBoundLabel: "Lower bound",
      plotUpperBoundLabel: "Upper bound",
      plotChartAriaLabel: "Function graph",
    ...
    formulaSheet: {
      ...
      toggleShow: "Show reference sheet",
      toggleHide: "Hide reference sheet",
      categories: {
        trigonometry: "Trigonometry",
        taylorSeries: "Taylor series (at 0)",
        derivatives: "Common derivatives",
        antiderivatives: "Common antiderivatives",
        algebraic: "Algebraic identities",
      },
      formulas: {
        trigPythagorean: "Pythagorean identity",
        trigTangent: "Tangent",
        trigDoubleSin: "Double angle — sine",
        trigDoubleCos: "Double angle — cosine",
        trigSumSin: "Angle sum — sine",
        trigSumCos: "Angle sum — cosine",
        trigOnePlusTan2: "1 + tan²(x)",
        taylorExp: "Exponential",
        taylorSin: "Sine",
        taylorCos: "Cosine",
        taylorLn: "Logarithm of (1+x)",
        taylorGeometric: "1 / (1 − x)",
        taylorBinomial: "(1 + x)^α",
        derivPower: "Power",
        derivSin: "Sine",
        derivCos: "Cosine",
        derivTan: "Tangent",
        derivExp: "Exponential",
        derivLn: "Natural logarithm",
        derivSqrt: "Square root",
        derivProduct: "Product (u·v)",
        derivQuotient: "Quotient (u/v)",
        intPower: "Power",
        intInverse: "1 / x",
        intExp: "Exponential",
        ...
        intArctan: "1 / (1 + x²)",
        intArcsin: "1 / √(1 − x²)",
        algSquareSum: "Square of a sum",
        algSquareDiff: "Square of a difference",
        algDiffSquares: "Difference of squares",
        algCubeSum: "Cube of a sum",
        algDiffCubes: "Difference of cubes",
        algSumCubes: "Sum of cubes",
      },
    },
    footer: {
